...
const Custom = () => {
  ...
  const [showSkinSelector, setShowSkinSelector] = useState(true); // New state
    ...
    <div className={`${styles.custom} animate-slide-up`}>
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.customSection}>
          {/* Toggle button */}
          <div>
            <button className={styles.toggleButton} onClick={() => setShowSkinSelector((prev) => !prev)}>
              {showSkinSelector ? (
                <svg viewBox="0 0 22 22" style={{ height: "28px", width: "28.px" }}>
                  <path
                    fill="currentColor"
                ...
                <svg viewBox="0 0 22 22" style={{ height: "28px", width: "28px" }}>
                  <path
                    fill="currentColor"
